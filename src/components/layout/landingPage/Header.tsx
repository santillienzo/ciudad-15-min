...
const Header = () => {
  ...
  return (
    ...
    // <header className="bg-slate-200 flex items-center justify-between xl:justify-start w-full py-4 px-8 h-[10vh] z-50 fixed top-0 left-0">
    //   <div className="xl:w-1/6 text-center z-50">
    //     <img src={Logo} alt="Ciudad en 15 minutos Logo" />
    //   </div>

    //   <nav
    //     className={`bg-slate-200 fixed w-[80%] md:w-[60%] xl:w-full h-full top-0 ${
    //       menuMobile ? "left-0" : "-left-full"
    //     } xl:static xl:h-auto flex-1 justify-center flex flex-col xl:flex-row items-center gap-10 transition-all duration-700 ease-in-out z-40`}
    //   >
    //     <ul className="flex flex-col xl:flex-row items-center gap-10 xl:gap-5 xl:mt-0 mt-20">
    //       <li>
    ...
    //       </li>
    //       <li>
    //         <a href="#contador" className="font-semibold">
    //           CONTADOR
    //         </a>
    //       </li>
    //       <li>
    ...
    //       </li>
    //       <li>
    //         <a href="#evento" className="font-semibold">
    //           EVENTO
    //         </a>
    //       </li>
    //       <li>
    //         <a href="#reglas" className="font-semibold">
    //           REGLAS
    //         </a>
    //       </li>
    //     </ul>
    ...
    // <header className="bg-slate-200 flex items-center justify-between xl:justify-start w-full py-4 px-8 h-10vh z-50 relative">
    //   <div className="xl:w-1/6 text-center z-50">
    //     <img src={Logo} alt="Ciudad en 15 minutos Logo" />
    //   </div>
    ...
    //       menuMobile ? "left-0" : "-left-full"
    //     } -rigth-full xl:static flex-1 justify-center flex flex-col xl:flex-row items-center gap-10 transition-all duration-700 ease-in-out z-40`}
    //   >
